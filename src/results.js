...
function RecordedEvent(ev) {
  ...
  this.created = new Date(ev.createdEpoch ? Long.fromValue(ev.createdEpoch).toNumber() : 0);
  this.createdEpoch = ev.createdEpoch ? Long.fromValue(ev.createdEpoch).toNumber() : 0;
